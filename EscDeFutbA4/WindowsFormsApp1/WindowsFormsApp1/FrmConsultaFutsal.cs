...
{
    public partial class FrmConsultaFutsal : Form
    {
        public FrmConsultaFutsal()
        {
            InitializeComponent();
        }
        ...
        private void txtEdadActual_TextChanged(object sender, EventArgs e)
        {
        ...
        public void EditarAlumnos(string id)
        {
            ...
            sql = "update alumnosfutsal set CiNro=@CiNro,Nombre=@Nombre,Apellido=@Apellido,Telefono=@Telefono,FechaNac=@FechaNac,Edad=@Edad,Categoria=@Categoria,Direccion=@Direccion,Foto=@Foto where id=@id";
            MySqlCommand comando;
            try
            {
        ...
        public void GetAll(string condicion)
        {
            ...
            DataSet resultado;
            sql = "select * from alumnosfutsal " + condicion;
        ...
        public void verImagen(PictureBox pbfoto, int Id)
        {
            ...
            try
            {
                MySqlConnection Conexion = new MySqlConnection("Server=localhost;" +
                                              ...
                                              "Uid=root;" +
                                              "Pwd=;");
                MySqlDataAdapter da = new MySqlDataAdapter($"SELECT Foto FROM alumnosfutsal", Conexion);
                DataRow dr;
        ...
        public void cargarRegistro(string id)
        {
            ...
            {
                modulo.AbrirConexion();
                sql = "select * from alumnosfutsal where id= " + id;
                consulta = new MySqlDataAdapter(sql, modulo.conexion);
        ...
        private void FrmConsultaFutsal_Load(object sender, EventArgs e)
        {
            GetAll("");
        }
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                verImagen(ptbFotoRegistros, id -1);
            }
        }
        ...
        private void txtCategoria_Click_1(object sender, EventArgs e)
        {
