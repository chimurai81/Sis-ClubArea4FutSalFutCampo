...
{
    public partial class FrmRegistroFutCampo : Form
    {
        public FrmRegistroFutCampo()
        {
            InitializeComponent();
        }
        ...
        private void txtCategoria_Click(object sender, EventArgs e)
        {
            ...
            txtCategoria.Text = $"{dtpFechNac.Value.Year.ToString()} Campo";
        }
        ...
        public void RegistrarAlumnos()
        {
            ...
            sql = "insert into alumnosfutbolcampo (CiNro,Nombre,Apellido,Telefono,FechaNac,Edad,Categoria,Direccion,Foto) values (@CiNro,@Nombre,@Apellido,@Telefono,@FechaNac,@Edad,@Categoria,@Direccion,@Foto)";
            MySqlCommand comando;
            try
            {
                ...
                comando.Parameters.AddWithValue("@Categoria", Convert.ToString(txtCategoria.Text));
